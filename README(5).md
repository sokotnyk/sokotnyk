...
![Languages](https://img.shields.io/badge/Languages-C_·_C%2B%2B_·_Python_·_JS_·_HTML_·_CSS-1D2B53?style=for-the-badge)
...
**Programming & Algorithms** · `C` `C++` `Python`
Solid foundation in C/C++ from coursework — data structures, algorithms, low-level logic. Use Python for scripting, automation, and general-purpose development.
...
Open to freelance work across both — from small scripts and automation tools to website layouts and landing pages.
